[#ftl]
[@b.head/]
  [@b.toolbar title = "<span style=\"color:blue\">" + grade.std.name + "（<span style=\"padding-left: 1px; padding-right: 1px\">" + grade.std.code + "</span>）于" + grade.acquiredOn?string("yyyy-MM-dd") +"获得“"+ grade.subject.name + "”</span>课程及认定明细"]
