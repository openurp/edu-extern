...
[@b.form name="certificateGradeForm" action="!save" theme="list"]
    ...
    [/@]
    [@b.select name="certificateGrade.subject.id" items=certificateSubjects?sort_by("name") empty="..." required="true" label="考试科目" value=(certificateGrade.subject.id)! style="width:150px"/]
    ...
    [@b.datepicker label="考试日期" name="certificateGrade.acquiredOn" value=(certificateGrade.acquiredOn)! required="true"/]
    [@b.textfield name="certificateGrade.examNo" label="准考证号码" value=(certificateGrade.examNo)! style="width:150px"/]
    [@b.textfield name="certificateGrade.certificate" label="证书编号" value=(certificateGrade.certificate)! maxlength="100" style="width:150px"/]
    [@b.formfoot]
