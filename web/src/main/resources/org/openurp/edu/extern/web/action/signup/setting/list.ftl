...
[@b.grid items=settings var="setting" ]
    ...
    [@b.row]
        [@b.boxcol/]
        [@b.col property="certificate.name" title="报名科目" width="17%"/]
        [@b.col title="费用" width="16%"]
        ...
        [@b.col title="条件"][#list setting.scopes as con] ${con.included?string('','限制:')}${(con.level.name)!} ${(con.grades)!('')}[#if con_has_next]&nbsp;[/#if][/#list][/@]
