...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        [@b.form class="navbar-form navbar-left" role="search" action="!editNew"]
            [@b.a class="btn btn-sm btn-info" href="!editNew"]<span class='glyphicon glyphicon-plus'></span>新建[/@]
        [/@]
        </li>
    </ul>
    </div>
  ...
  [#assign title]
     ...
     [@b.a href="!edit?id="+exchangeStudent.id class="btn btn-sm btn-warning"]<span class="glyphicon glyphicon-remove"></span>删除[/@]
     [/#if]
  [/#assign]
  [@panel title=title]
