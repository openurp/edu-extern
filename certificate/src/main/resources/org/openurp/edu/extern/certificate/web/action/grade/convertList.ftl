[#ftl]
[@b.head/]
  [@b.toolbar title = "<span style=\"color:blue\">" + grade.std.user.name + "（<span style=\"padding-left: 1px; padding-right: 1px\">" + grade.std.user.code + "</span>）于" + grade.acquiredOn?string("yyyy-MM-dd") +"获得“"+ grade.subject.name + "”</span>课程及认定明细"]
  ...
  [@b.grid items=convertedGrades?sort_by(["course", "code"]) var="courseGrade" sortable="false"]
    ...
    [@b.row]
      ...
      [@b.col title="课程名称" property="course.name" width="30%"/]
