...
<script>
    ...
    function exportData(){
        ...
        bg.form.addInput(form,"keys","std.user.code,std.user.name,subject.category.name,subject.name,score,scoreText,std.state.department.name,std.state.major.name,std.grade,certificate,acquiredOn,examNo,updatedAt,courseSize");
